__title__ = 'ulgdp-road-asset-processing-toolset'
__version__ = '0.0.0'
__author__ = 'Nur Yahya'
__license__ = 'Apache 2.0'
__copyright__ = 'Copyright 2023 by Nur Yahya'
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from ulgdp_road_asset_processing_toolset import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from ulgdp_road_asset_processing_toolset import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from ulgdp_road_asset_processing_toolset import ExampleObject
