...
if pkgutil.find_loader('ulgdp_road_asset_processing_toolset') is None:
    ...
    if not src_dir.exists():
        raise EnvironmentError('Unable to import ulgdp_road_asset_processing_toolset.')

    # add the source directory to the paths searched when importing
    sys.path.insert(0, str(src_dir))

# import the project package
import ulgdp_road_asset_processing_toolset
